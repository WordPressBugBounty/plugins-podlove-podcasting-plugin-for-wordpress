...
use PodlovePublisher_Vendor\Swift_Message;
use PodlovePublisher_Vendor\Swift;
/**
...
class SwiftMailerHandler extends MailHandler
{
     ...
     */
    public function __construct(\PodlovePublisher_Vendor\Swift_Mailer $mailer, $message, $level = Logger::ERROR, bool $bubble = \true)
    {
