...
use PodlovePublisher_Vendor\Monolog\Formatter\LineFormatter;
use PodlovePublisher_Vendor\Monolog\Formatter\FormatterInterface;
use PodlovePublisher_Vendor\Monolog\Logger;
use PodlovePublisher_Vendor\Monolog\Utils;
use PodlovePublisher_Vendor\PhpConsole\Connector;
use PodlovePublisher_Vendor\PhpConsole\Handler as VendorPhpConsoleHandler;
use PodlovePublisher_Vendor\PhpConsole\Helper;
/**
...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    ...
    {
        if (!class_exists('PodlovePublisher_Vendor\PhpConsole\Connector')) {
