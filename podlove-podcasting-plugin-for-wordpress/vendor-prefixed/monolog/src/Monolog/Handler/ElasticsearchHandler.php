 ...
 */
namespace PodlovePublisher_Vendor\Monolog\Handler;

use PodlovePublisher_Vendor\Elastic\Elasticsearch\Response\Elasticsearch;
use Throwable;
use RuntimeException;
use PodlovePublisher_Vendor\Monolog\Logger;
use PodlovePublisher_Vendor\Monolog\Formatter\FormatterInterface;
use PodlovePublisher_Vendor\Monolog\Formatter\ElasticsearchFormatter;
use InvalidArgumentException;
use PodlovePublisher_Vendor\Elasticsearch\Common\Exceptions\RuntimeException as ElasticsearchRuntimeException;
use PodlovePublisher_Vendor\Elasticsearch\Client;
use PodlovePublisher_Vendor\Elastic\Elasticsearch\Exception\InvalidArgumentException as ElasticInvalidArgumentException;
use PodlovePublisher_Vendor\Elastic\Elasticsearch\Client as Client8;
/**
