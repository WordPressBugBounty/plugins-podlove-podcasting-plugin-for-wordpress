...
use PodlovePublisher_Vendor\Monolog\Formatter\JsonFormatter;
use PodlovePublisher_Vendor\PhpAmqpLib\Message\AMQPMessage;
use PodlovePublisher_Vendor\PhpAmqpLib\Channel\AMQPChannel;
use AMQPExchange;
/**
