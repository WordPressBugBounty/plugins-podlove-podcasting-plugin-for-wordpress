...
use PodlovePublisher_Vendor\Twig\Node\Expression\Binary\HasEveryBinary;
use PodlovePublisher_Vendor\Twig\Node\Expression\Binary\HasSomeBinary;
...
final class CoreExtension extends AbstractExtension
{
    ...
    public function getFilters() : array
    {
        return [
            // formatting filters
            new TwigFilter('date', 'PodlovePublisher_Vendor\twig_date_format_filter', ['needs_environment' => \true]),
            new TwigFilter('date_modify', 'PodlovePublisher_Vendor\twig_date_modify_filter', ['needs_environment' => \true]),
            new TwigFilter('format', 'PodlovePublisher_Vendor\twig_sprintf'),
            new TwigFilter('replace', 'PodlovePublisher_Vendor\twig_replace_filter'),
            new TwigFilter('number_format', 'PodlovePublisher_Vendor\twig_number_format_filter', ['needs_environment' => \true]),
            new TwigFilter('abs', 'abs'),
            new TwigFilter('round', 'PodlovePublisher_Vendor\twig_round'),
            // encoding
            new TwigFilter('url_encode', 'PodlovePublisher_Vendor\twig_urlencode_filter'),
            new TwigFilter('json_encode', 'json_encode'),
            new TwigFilter('convert_encoding', 'PodlovePublisher_Vendor\twig_convert_encoding'),
            // string filters
            new TwigFilter('title', 'PodlovePublisher_Vendor\twig_title_string_filter', ['needs_environment' => \true]),
            new TwigFilter('capitalize', 'PodlovePublisher_Vendor\twig_capitalize_string_filter', ['needs_environment' => \true]),
            new TwigFilter('upper', 'PodlovePublisher_Vendor\twig_upper_filter', ['needs_environment' => \true]),
            new TwigFilter('lower', 'PodlovePublisher_Vendor\twig_lower_filter', ['needs_environment' => \true]),
            new TwigFilter('striptags', 'PodlovePublisher_Vendor\twig_striptags'),
            new TwigFilter('trim', 'PodlovePublisher_Vendor\twig_trim_filter'),
            new TwigFilter('nl2br', 'PodlovePublisher_Vendor\twig_nl2br', ['pre_escape' => 'html', 'is_safe' => ['html']]),
            new TwigFilter('spaceless', 'PodlovePublisher_Vendor\twig_spaceless', ['is_safe' => ['html']]),
            // array helpers
            new TwigFilter('join', 'PodlovePublisher_Vendor\twig_join_filter'),
            new TwigFilter('split', 'PodlovePublisher_Vendor\twig_split_filter', ['needs_environment' => \true]),
            new TwigFilter('sort', 'PodlovePublisher_Vendor\twig_sort_filter', ['needs_environment' => \true]),
            new TwigFilter('merge', 'PodlovePublisher_Vendor\twig_array_merge'),
            new TwigFilter('batch', 'PodlovePublisher_Vendor\twig_array_batch'),
            new TwigFilter('column', 'PodlovePublisher_Vendor\twig_array_column'),
            new TwigFilter('filter', 'PodlovePublisher_Vendor\twig_array_filter', ['needs_environment' => \true]),
            new TwigFilter('map', 'PodlovePublisher_Vendor\twig_array_map', ['needs_environment' => \true]),
            new TwigFilter('reduce', 'PodlovePublisher_Vendor\twig_array_reduce', ['needs_environment' => \true]),
            // string/array filters
            new TwigFilter('reverse', 'PodlovePublisher_Vendor\twig_reverse_filter', ['needs_environment' => \true]),
            new TwigFilter('length', 'PodlovePublisher_Vendor\twig_length_filter', ['needs_environment' => \true]),
            new TwigFilter('slice', 'PodlovePublisher_Vendor\twig_slice', ['needs_environment' => \true]),
            new TwigFilter('first', 'PodlovePublisher_Vendor\twig_first', ['needs_environment' => \true]),
            new TwigFilter('last', 'PodlovePublisher_Vendor\twig_last', ['needs_environment' => \true]),
            // iteration and runtime
            new TwigFilter('default', 'PodlovePublisher_Vendor\_twig_default_filter', ['node_class' => DefaultFilter::class]),
            new TwigFilter('keys', 'PodlovePublisher_Vendor\twig_get_array_keys_filter'),
        ];
    }
    public function getFunctions() : array
    {
        return [new TwigFunction('max', 'max'), new TwigFunction('min', 'min'), new TwigFunction('range', 'range'), new TwigFunction('constant', 'PodlovePublisher_Vendor\twig_constant'), new TwigFunction('cycle', 'PodlovePublisher_Vendor\twig_cycle'), new TwigFunction('random', 'PodlovePublisher_Vendor\twig_random', ['needs_environment' => \true]), new TwigFunction('date', 'PodlovePublisher_Vendor\twig_date_converter', ['needs_environment' => \true]), new TwigFunction('include', 'PodlovePublisher_Vendor\twig_include', ['needs_environment' => \true, 'needs_context' => \true, 'is_safe' => ['all']]), new TwigFunction('source', 'PodlovePublisher_Vendor\twig_source', ['needs_environment' => \true, 'is_safe' => ['all']])];
    }
    public function getTests() : array
    {
        return [new TwigTest('even', null, ['node_class' => EvenTest::class]), new TwigTest('odd', null, ['node_class' => OddTest::class]), new TwigTest('defined', null, ['node_class' => DefinedTest::class]), new TwigTest('same as', null, ['node_class' => SameasTest::class, 'one_mandatory_argument' => \true]), new TwigTest('none', null, ['node_class' => NullTest::class]), new TwigTest('null', null, ['node_class' => NullTest::class]), new TwigTest('divisible by', null, ['node_class' => DivisiblebyTest::class, 'one_mandatory_argument' => \true]), new TwigTest('constant', null, ['node_class' => ConstantTest::class]), new TwigTest('empty', 'PodlovePublisher_Vendor\twig_test_empty'), new TwigTest('iterable', 'PodlovePublisher_Vendor\twig_test_iterable')];
    }
...
{
    if (!$arrow instanceof \Closure && $env->hasExtension('PodlovePublisher_Vendor\\Twig\\Extension\\SandboxExtension') && $env->getExtension('PodlovePublisher_Vendor\\Twig\\Extension\\SandboxExtension')->isSandboxed()) {
