...
class ParseTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $Expected = array(array('step' => array('instrument' => 'Lasik 2000', 'pulseEnergy' => 5.4, 'pulseDuration' => 12, 'repetition' => 1000, 'spotSize' => '1mm')), array('step' => array('instrument' => 'Lasik 2000', 'pulseEnergy' => 5.4, 'pulseDuration' => 12, 'repetition' => 1000, 'spotSize' => '2mm')));
    ...
    {
        $this->assertSame(\true, $this->yaml['True']);
    }
    ...
    {
        $this->assertEquals(array("YAML is so easy to learn.", "Your config files will never be the same."), $this->yaml[3]);
    }
    public function testSeqMap()
    {
        $this->assertEquals(array("cpu" => "1.5ghz", "ram" => "1 gig", "os" => "os x 10.4.1"), $this->yaml[4]);
    }
    ...
    {
        $this->assertEquals(array("program" => "Adium", "platform" => "OS X", "type" => "Chat Client"), $this->yaml[5]);
    }
    ...
    {
        $this->assertEquals(array(array("name" => "spartan", "notes" => array("Needs to be backed up", "Needs to be normalized"), "type" => "mysql")), $this->yaml['databases']);
    }
    ...
    {
        $this->assertEquals(array("This", array("Is", "Getting", array("Ridiculous", "Guys")), "Seriously", array("Show", "Mercy")), $this->yaml[8]);
    }
    ...
    {
        $this->assertEquals(array("name" => "mark", "age" => "older than chris", "brand" => array("marlboro", "lucky strike")), $this->yaml[10]);
    }
    ...
    {
        $this->assertEquals(array(array('Perl', 'Python', 'PHP', 'Ruby'), array('C/C++', 'Java')), $this->yaml['all languages']);
    }
...
dog', $this->yaml['many_lines']);
    ...
    public function testElementWithEmptyHash()
    {
        ...
        $yaml = Spyc::YAMLLoadString($element, ['setting_empty_hash_as_object' => \true]);
